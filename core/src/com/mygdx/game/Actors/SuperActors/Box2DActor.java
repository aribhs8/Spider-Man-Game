...
public class Box2DActor extends AnimatedActor
{
    ...
    public float getDensity() { return fixtureDef.density; }
    public float getFriction() { return fixtureDef.friction; }
    public float getRestitution() { return fixtureDef.restitution; }
    ...
    public float getMaxSpeedY(float f) { return maxSpeedY; }
